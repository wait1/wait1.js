...
module.exports = function(params, WS) {
...
Connection.prototype._onmessage = function(evt) {
  ...
  for (var i = 0, res; i < msg.length; i++) {
    res = msg[i];
    this.emit('RESPONSE_' + res[0], res[1], res[2], res[3]);
  }
};
...
Connection.prototype.thunk = function(id, timeout) {
